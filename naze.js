...
let llamaPrompt = "ngobrol singkat dengan bahasa indonesia tidak baku dan kamu adalah MorelyBot";
let userPrompt = "kalo jawab pake bahasa indonesia ga baku aja dan kamu adalah MorelyBot"; // Default prompt
			...
			sych.sendMessage(m.chat, {
				...
				contextInfo: {
					externalAdReply: {
						...
						"sourceUrl": 'https://github.com/NHEBotx'
					}
				}
			}, {
				quoted: fkontak
        ...
        react: {
            ...
            key: m.key
				...
				await sych.sendMessage(m.chat, {
					document: audio,
					mimetype: 'audio/mpeg',
					fileName: `Convert By Morely Bot.mp3`
				}, {
					quoted: m
				})
			}
        ...
        react: {
            ...
            key: m.key
					...
					if (hasil.status !== 200 || !hasil.data) {
						...
						await sych.sendFileUrl(m.chat, hasil.data, `*🎐ada yang mau coli nich,Video Link:* ${hasil.data}`, m);
					}
				} catch (e) {
...
${f}---IG:𝗘𝗿𝗹𝘆𝘆𝗮𝗿𝗻𝗱𝗮─────╔═╝║
${f}--------IG:𝙏𝙣𝙜𝙭𝙖𝙟𝙖─────╚══╝
JANGAN LUPA SUPPORT Follow Me On Instagram 
...
if (typemenu === 's1') {
                    sych.sendMessage(m.chat, {
    image: fs.readFileSync('./MorelyMedia/menu/sychy.jpg'),
    caption: inimenu,
    contextInfo: {
        mentionedJid: [m.sender, '0@s.whatsapp.net', owner[0] + '@s.whatsapp.net']
    }
    ...
    quoted: m
                    ...
                    sych.sendMessage(m.chat, {
                        ...
                        mentionedJid: [m.sender, '0@s.whatsapp.net', owner[0] + '@s.whatsapp.net'],
                            externalAdReply: {
                                ...
                                title: botname,
                                body: owname,
                                thumbnail: fs.readFileSync('./MorelyMedia/menu/sychy.jpg'),
                                sourceUrl: my.gc,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
                    ...
                    sych.sendMessage(m.chat, {
    video: fs.readFileSync('./MorelyMedia/menu/sych.mp4'),
    caption: inimenu,
    contextInfo: {
        mentionedJid: [m.sender, '0@s.whatsapp.net', owner[0] + '@s.whatsapp.net']
    }
    ...
    await sych.sendMessage(m.chat, {
        video: fs.readFileSync('MorelyMedia/menu/gif.mp4'),
        caption: inimenu,
        gifPlayback: true,
        contextInfo: {
            mentionedJid: [m.sender, '0@s.whatsapp.net', owner[0] + '@s.whatsapp.net'],
    ...
    await sych.sendMessage(m.chat, {
        audio: fs.readFileSync('MorelyMedia/menu/audio.mp3'),
        mimetype: 'audio/mp4',
        ptt: false
    }, { quoted: qchanel });
                } else if (typemenu === 's5') {
    ...
    await sych.sendMessage(m.chat, {
        react: {
            ...
            key: m.key
				...
				sycreply('JANGAN LUPA SUPPORT Follow Me On Instagram @erlyyarnda: https://www.instagram.com/erlyyarnda And Follow @tngxaja: https://www.instagram.com/tngxaja')
				let profile;
				try {
					profile = await sych.profilePictureUrl(m.sender, 'image');
				} catch (e) {
