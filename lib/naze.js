...
let llamaPrompt = "ngobrol singkat dengan bahasa indonesia tidak baku dan kamu adalah MorelyBotz";
let userPrompt = "kalo jawab pake bahasa indonesia ga baku aja dan kamu adalah MorelyBotz"; // Default prompt
...
for (const emoji of reactEmojis) {
    await sych.sendMessage(m.chat, {
        react: {
			...
			case 'script':
			case 'esce': {
				const iniesce = `https://github.com/NHEBotx/sychee\n⬆️ Itu Sc nya cuy`
